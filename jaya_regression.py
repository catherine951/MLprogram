...
def fitness(data, target, pop, X_test, y_test, n_cv=5):
    """
    得到测试集的误差列向量
    :param data: 训练集特征向量
    :param target: 训练集目标向量
...
data, target = load_ds_xlsx('1251.xlsx')
bound = np.array([[0, 100], [0, 100]])
n = 10
d = 2
gm = 100
X_test = [1.316833333, 0.065875883, 0.12893797, 14.89668823, 0.45875305, 8.333333333, 3.432707757]
